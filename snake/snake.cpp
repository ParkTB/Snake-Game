...
void snake::start()
{
    int menuCode = titleDraw();
    if (menuCode == 0){
        int stage = stageSelect();
        switch (stage){
            case 0:
                gLoop(0);
...
int snake::failDraw(){
    ...
    printw("         ( You can play the game again by pressing Restart )");
    int y = 12;
    int x = 27;
...
char map2[26][51] = {
    ...
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000100000000000000000000000000010000000000001"},
    {"10000000100000000000000000000000000010000000000001"},
    {"10000000100000000000000000000000000010000000000001"},
    {"10000000100000000000000100000000000010000000000001"},
    {"10000000100000000000000100000000000010000000000001"},
    {"10000000100000000000000100000000000010000000000001"},
    {"10000000100000000000000100000000000010000000000001"},
    {"10000000100000000000000100000000000010000000000001"},
...
char map3[26][51] = {
    ...
    {"10000000000000000000000000001000000000000000000001"},
    {"10000000000000000000000000001000000000000000000001"},
    {"10000000000000000000000000001111111111111000000001"},
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000000000000000034400000000000000000000000001"},
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000111111111111111000000000000000000000000001"},
...
char map4[26][51] = {
    ...
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000000000000000000000000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000034410000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000001111111111111111121111111111111111110000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
    {"10000000000000000000000010000000000000000000000001"},
...
int snake::getScore() {
        return maxLength*10 + gItemCnt*5 + pItemCnt*5 + passGateCnt*20 + currentLength;
}

bool snake::missionCheck(){

    if (gItemCnt >= goalGItem && pItemCnt >= goalPItem && passGateCnt >= goalPassGate && maxLength >= goalMaxLength){
        return true;
    }
    return false;
...
void snake::scoreBoard(){
    ...
    mvprintw(3, 60, "*  B : %d / %d            *", currentLength, maxLength);
    mvprintw(4, 60, "*  + : %d                *", gItemCnt);
    mvprintw(5, 60, "*  - : %d                *", pItemCnt);
    mvprintw(6, 60, "*  G : %d                *", passGateCnt);
    mvprintw(7, 60, "*************************");
